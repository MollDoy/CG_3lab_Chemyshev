...
LRESULT CALLBACK InfoWindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        CreateWindowEx(0, "STATIC", "Чемышев Семён ЭВМб-22-1", WS_CHILD | WS_VISIBLE | SS_CENTER,
...
void Init()
{
    Menu_AddButton("Info", 20, 20, 300, 60, 4);
    Menu_AddButton("Block", 20, 90, 200, 60, 4);
    Menu_AddButton("Run", 20, 160, 200, 60, 4);
    Menu_AddButton("Idle", 20, 230, 200, 60, 4);
    Menu_AddButton("Exit", 20, 300, 200, 60, 4);


    textureSprite1 = LoadTexture("BLOCK.png");
